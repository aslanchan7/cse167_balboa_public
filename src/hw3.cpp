...
void hw_3_3(const std::vector<std::string> &params) {
    ...
    // shader class
    Shader shader = Shader("C:/Users/Aslan/Classes/2025-2026/CSE 167/cse167_balboa_public/src/shaders/shader.vs", "C:/Users/Aslan/Classes/2025-2026/CSE 167/cse167_balboa_public/src/shaders/shader.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        Matrix4x4f viewMatrix = inverse(scene.camera.cam_to_world);
        for (int i = 0; i < 4; i++)
        {
            for (int j = 0; j < 4; j++)
            {
                view[i][j] = viewMatrix(j, i);
            }
        }
